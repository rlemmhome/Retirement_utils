...
public class BoldinGuardrailsSim_claude extends JFrame {
    ...
    private SimResult runOneSimulation(
        ...
        for (int yr = 0; yr < years; yr++) {
            ...
            // ── Portfolio draw = guardrail withdrawal (SS/other income is ADDITIVE) ─
            // The retiree draws the full guardrail amount from the portfolio AND
            // receives SS and other income on top. Income sources are never subtracted
            // from the portfolio draw — they are separate household income streams.
            ...
            // ── Current withdrawal rate = portfolio draw / portfolio balance ───────
            ...
            // If the IRS RMD exceeds the guardrail withdrawal, the retiree must
            // draw the RMD amount from the portfolio instead.
            ...
            // = portfolio draw + all outside income sources.
            // SS and annuity are ADDITIVE to the portfolio draw, not substitutes.
