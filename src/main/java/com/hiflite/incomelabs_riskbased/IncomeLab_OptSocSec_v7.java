// ==============================================================
// IncomeLab_OptSocSec_v7.java
// Last modified: Wednesday, August 12, 2026 at 11:03 AM MST (UTC-7)
// ==============================================================
 ...
 *     reproduces the pre-v5 hardcoded behavior EXACTLY) and Custom (a user-entered flat rate with two flags: "tax Social Security" and "exclude
 ...
 *
 * =============================================================================
 * Compile:  javac IncomeLab_OptSocSec_v7.java
 * Run:      java com.hiflite.incomelabs_riskbased.IncomeLab_OptSocSec_v7
 * Requires Java 11+. No external dependencies.
 */
public class IncomeLab_OptSocSec_v7 extends JFrame {
    ...
    private static final String APP_VERSION = "v7";
    private static final String BUILD_STAMP = "Wednesday, August 12, 2026 at 11:03 AM MST (UTC-7)";
    ...
    private JScrollPane buildTablePanel() {
        String[] cols = {
                ...
                "Trad Bal", "Roth Bal", "Money Mkt",                       // 27 28 29 (v6)
        ...
        JTableHeader hdr = new JTableHeader(tblPro.getColumnModel()) {
            @Override public String getToolTipText(MouseEvent e) {
                ...
                return switch (col) {
                    ...
                    case 31 -> "<html><b>SS bridge (v6) -- extra draw replacing a delayed benefit</b><br>"
                    ...
                    case 29 -> "<html><b>Money Mkt (v6) -- taxable / money market bucket</b><br>"
    ...
    /** v7: modal editor for the base-year (2026) IRMAA cliffs and ordinary-bracket tops, MFJ and Single. Edits the frame's editable arrays in place
    ...
    private ProResults simulatePro(SimInputs inp, long seed,
        ...
        // v6: two combined buckets tracked as tagged subcomponents of the same
