...
public class IncomeLab_OptSocSec_v4 extends JFrame {
    ...
    private JPanel buildInputPanel() {
        ...
        cmbFilingStatus.setToolTipText("<html><b>Filing status (federal + SS taxation + IRMAA basis)</b><br>"
                ...
                + "scenario. See the Assumptions &amp; Methods tab.</html>");
        ...
        for (int y = 0; y < inp.horizon; y++) {
            ...
            if (drawing && inp.computedTax) {
                ...
                double taxSSpre = TaxEngine.taxableSocialSecurity(
                        grossSS, ordinaryBeforeConv, inflFactor, inp.filingStatus);
                ...
                if (inp.convFillMode) {
                    double[] fill = TaxEngine.fillConversion(
                            ...
                            inp.convCap, inflFactor, inp.filingStatus);
                    conv        = fill[0];
                ...
                double[] ctax = TaxEngine.conversionTax(
                        tr.taxableIncome, conv, inflFactor, inp.filingStatus);
