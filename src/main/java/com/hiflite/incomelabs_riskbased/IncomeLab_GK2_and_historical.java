...
/**
 * IncomeLab_GK2_and_historical.java
 *
 ...
 *
 * ─────────────────────────────────────────────────────────────────────────────
 * Compile:  javac IncomeLab_GK2_and_historical.java
 * Run:      java IncomeLab_GK2_and_historical
 * Requires Java 11+. No external dependencies.
 */
public class IncomeLab_GK2_and_historical extends JFrame {
    ...
    public IncomeLab_GK2_and_historical() {
        super("IncomeLab Pro + GK + Historical Stress — Enhanced PoS-Driven Withdrawal Simulator");
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            ...
            new IncomeLab_GK2_and_historical();
        });
    }
}
