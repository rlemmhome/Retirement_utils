 ...
 *
 * =============================================================================
 * Compile:  javac IncomeLab_OptSocSec_v5.java
 * Run:      java com.hiflite.incomelabs_riskbased.IncomeLab_OptSocSec_v5
 * Requires Java 11+. No external dependencies.
 */
public class IncomeLab_OptSocSec_v5 extends JFrame {
        ...
        for (int y = 0; y < inp.horizon; y++) {
            ...
            if (drawing && inp.computedTax) {
                ...
                TaxEngine.TaxResult tr = TaxEngine.compute(
                        ...
                        inp.filingStatus, stProfile, calYear, tradDraw);
